    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size', models.CharField(choices=[('S', 'Small'), ('M', 'Medium'), ('L', 'Large')], max_length=10, null='True', verbose_name='사이즈')),
                ...
                ('color', models.CharField(choices=[('red', 'Red'), ('beige', 'Beige'), ('purple', 'Purple')], max_length=20, null='True', verbose_name='색상')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('satisfaction', models.CharField(choices=[('1', '1'), ('4', '4'), ('3', '3'), ('2', '2'), ('5', '5')], max_length=10, verbose_name='만족도')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='등록날짜')),
            ],
            options={
                'verbose_name': '리뷰',
