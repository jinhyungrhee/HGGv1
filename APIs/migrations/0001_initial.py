# Generated by Django 4.0.4 on 2022-07-31 07:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('univ', models.CharField(choices=[('한국외대', '한국외대'), ('경희대', '경희대')], max_length=10, verbose_name='소속대학')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('satisfaction', models.CharField(choices=[('3', '3'), ('2', '2'), ('1', '1'), ('5', '5'), ('4', '4')], max_length=10, verbose_name='만족도')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='등록날짜')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receive', models.CharField(choices=[('택배수령', '택배수령'), ('대면수령', '대면수령')], max_length=10, verbose_name='수령방법')),
                ('address', models.CharField(blank='True', max_length=50, null='True', verbose_name='주소')),
                ('color', models.CharField(choices=[('beige', 'Beige'), ('purple', 'Purple'), ('red', 'Red')], max_length=20, null='True', verbose_name='색상')),
