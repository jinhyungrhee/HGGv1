    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('satisfaction', models.CharField(choices=[('3', '3'), ('4', '4'), ('1', '1'), ('2', '2'), ('5', '5')], max_length=10, verbose_name='만족도')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='등록날짜')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('red', 'Red'), ('purple', 'Purple'), ('beige', 'Beige')], max_length=20, null='True', verbose_name='색상')),
